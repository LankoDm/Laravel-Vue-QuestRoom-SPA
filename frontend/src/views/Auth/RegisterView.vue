...
/**
 * Initiate Google OAuth registration/login process.
 * Fetches the authorization URL from the backend and redirects the user.
 */
...
/**
 * Handle standard user registration submission.
 * Validates password match before sending the request.
 */
    ...
    <div class="min-h-[80vh] flex items-center justify-center px-6 py-12">
        <div class="max-w-md w-full bg-white rounded-3xl shadow-lg border border-secondary p-8">
            ...
            <div v-if="errorMessage"
                 class="mb-6 p-4 bg-red-50 text-red-600 rounded-xl text-sm font-medium text-center border border-red-100">
                {{ errorMessage }}
            </div>
