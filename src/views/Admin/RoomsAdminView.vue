  ...
  <div>
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8">
      ...
      <div class="flex gap-4 w-full md:w-auto">
        ...
        <RouterLink :to="{ name: 'admin.rooms.create' }" class="bg-primary hover:bg-purple-500 text-white px-6 py-3 rounded-xl font-bold shadow-md transition-colors flex items-center justify-center gap-2 shrink-0">
    ...
    <div v-else class="bg-white rounded-3xl shadow-sm border border-secondary overflow-hidden">
          ...
          <tr v-for="room in rooms" :key="room.id" class="hover:bg-gray-50 transition-colors">
            ...
            <td class="p-4 text-center">
              <div class="flex items-center justify-center gap-2">
                <RouterLink :to="{ name: 'admin.rooms.edit', params: { id: room.id } }" class="block p-2 text-blue-500 hover:bg-blue-50 rounded-lg transition-colors cursor-pointer" title="Редагувати">
      ...
      <div v-if="lastPage > 1" class="p-6 bg-gray-50 border-t border-gray-100 flex justify-center items-center gap-2">
